 ...
 * @author sa356713 
 * 
 * 		   A non-empty array A consisting of N integers is given. Array
...
public class TapeEquilibrium implements Test{
	...
	public int splitAndCompute(int pn, int[] A) 
	{
...
//		System.out.println("diff="+Math.abs(rightSum-leftSum));
		return Math.abs(rightSum-leftSum);
	}
	
	public static void main(String[] args) {
		TestImpl.testArrayExamples(new TapeEquilibrium());
